...
var Markers = function (_a) {
    ...
    var node = React.useRef();
    var _d = __read(React.useState(false), 2), needDeleteActive = _d[0], setNeedDeleteActive = _d[1];
    var _e = __read(React.useState(false), 2), hideStop = _e[0], setHideStop = _e[1];
...
var GradientPanel = function (_a) {
    ...
    var _j = __read(React.useState(RADIALS_POS), 2), radialsPosition = _j[0], setRadialPosition = _j[1];
    ...
    return (React__default['default'].createElement("div", { className: 'gradient-interaction' },
        ...
        showGradientStops && (React__default['default'].createElement(Markers, { color: color, setColor: setColor, activeColor: activeColor, setActiveColor: setActiveColor, setInit: setInit, format: format, showAlpha: showAlpha }))));
};
...
var Gradient = function (_a) {
    ...
    var activeStop = rgbaToHex([lastStop[0], lastStop[1], lastStop[2]]);
    var activeIdx = stops[stops.length - 1][2];
    var _q = __read(React.useState(true), 2), init = _q[0], setInit = _q[1];
    ...
    var _s = __read(React.useState(initColor), 2), color = _s[0], setColor = _s[1];
    ...
    return (React__default['default'].createElement("div", { className: 'colorpicker' },
        ...
        React__default['default'].createElement(DefaultColorPanel, { defaultColors: defaultColors, setColor: setColor, setActiveColor: setActiveColor, setInit: setInit, limit: defaultColorsLimit, colorType: 'gradient' })));
};
...
var ColorPickerSolid = function (_a) {
    ...
    return (React__default['default'].createElement("div", { ref: node, className: 'colorpicker' },
        ...
        React__default['default'].createElement(DefaultColorPanel, { defaultColors: defaultColors, setColor: setColor, setInit: setInit, colorType: 'solid', limit: defaultColorsLimit })));
};
...
var ColorPicker = function (_a) {
    var _b = _a.value, value = _b === void 0 ? '#ffffff' : _b, _c = _a.format, format = _c === void 0 ? 'rgb' : _c, _d = _a.gradient, gradient = _d === void 0 ? false : _d, _e = _a.solid, solid = _e === void 0 ? true : _e, _f = _a.debounceMS, debounceMS = _f === void 0 ? 300 : _f, _g = _a.debounce, debounce = _g === void 0 ? true : _g, _h = _a.showAlpha, showAlpha = _h === void 0 ? true : _h, _j = _a.showInputs, showInputs = _j === void 0 ? true : _j, _k = _a.showGradientResult, showGradientResult = _k === void 0 ? true : _k, _l = _a.showGradientStops, showGradientStops = _l === void 0 ? true : _l, _m = _a.showGradientMode, showGradientMode = _m === void 0 ? true : _m, _o = _a.showGradientAngle, showGradientAngle = _o === void 0 ? true : _o, _p = _a.showGradientPosition, showGradientPosition = _p === void 0 ? true : _p, _q = _a.popupWidth, popupWidth = _q === void 0 ? 267 : _q, _r = _a.colorBoardHeight, colorBoardHeight = _r === void 0 ? 120 : _r, _s = _a.defaultColors, defaultColors = _s === void 0 ? DEFAULT_COLORS : _s, defaultActiveTab = _a.defaultActiveTab, onChangeTabs = _a.onChangeTabs, _t = _a.onChange, onChange = _t === void 0 ? function () { return ({}); } : _t;
    var _u = __read(React.useState(defaultActiveTab || getIndexActiveTag(value)), 2), activeTab = _u[0], setActiveTab = _u[1];
        ...
        return (React__default['default'].createElement(PopupTabs, { activeTab: activeTab, popupWidth: popupWidth },
            ...
            React__default['default'].createElement(PopupTabsBody, null,
                ...
                React__default['default'].createElement(PopupTabsBodyItem, { tabName: 'gradient' },
                    React__default['default'].createElement(Gradient, { onChange: onChangeGradient, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, showGradientResult: showGradientResult, showGradientStops: showGradientStops, showGradientMode: showGradientMode, showGradientAngle: showGradientAngle, showGradientPosition: showGradientPosition, colorBoardHeight: colorBoardHeight })))));
    }
    return (React__default['default'].createElement(React__default['default'].Fragment, null, solid || gradient ? (React__default['default'].createElement(PopupTabs, { popupWidth: popupWidth },
        React__default['default'].createElement(PopupTabsBody, null,
            ...
            gradient ? (React__default['default'].createElement(Gradient, { onChange: onChangeGradient, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, showGradientResult: showGradientResult, showGradientStops: showGradientStops, showGradientMode: showGradientMode, showGradientAngle: showGradientAngle, showGradientPosition: showGradientPosition, colorBoardHeight: colorBoardHeight })) : (React__default['default'].createElement(React.Fragment, null))))) : null));
};
