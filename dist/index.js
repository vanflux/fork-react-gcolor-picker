        ...
        return (React__default['default'].createElement(PopupTabs, { activeTab: activeTab, popupWidth: popupWidth },
            ...
            React__default['default'].createElement(PopupTabsBody, null,
                React__default['default'].createElement(PopupTabsBodyItem, { tabName: 'solid' },
                    React__default['default'].createElement(ColorPickerSolid, { onChange: onChangeSolid, value: value, format: format, defaultColors: defaultColors, defaultColorsLimit: defaultColorsLimit, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, colorBoardHeight: colorBoardHeight })),
                React__default['default'].createElement(PopupTabsBodyItem, { tabName: 'gradient' },
                    React__default['default'].createElement(Gradient, { onChange: onChangeGradient, value: value, format: format, defaultColors: defaultColors, defaultColorsLimit: defaultColorsLimit, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, showGradientResult: showGradientResult, showGradientStops: showGradientStops, showGradientMode: showGradientMode, showGradientAngle: showGradientAngle, showGradientPosition: showGradientPosition, colorBoardHeight: colorBoardHeight })))));
    }
