...
var ColorPicker = function (_a) {
    ...
    var _u = __read(useState(defaultActiveTab || getIndexActiveTag(value)), 2), activeTab = _u[0], setActiveTab = _u[1];
        ...
        return (React.createElement(PopupTabs, { activeTab: activeTab, popupWidth: popupWidth },
            ...
            React.createElement(PopupTabsBody, null,
                ...
                React.createElement(PopupTabsBodyItem, { tabName: 'gradient' },
                    React.createElement(Gradient, { onChange: onChangeGradient, value: value, format: format, defaultColors: defaultColors, debounceMS: debounceMS, debounce: debounce, showAlpha: showAlpha, showInputs: showInputs, showGradientResult: showGradientResult, showGradientStops: showGradientStops, showGradientMode: showGradientMode, showGradientAngle: showGradientAngle, showGradientPosition: showGradientPosition, colorBoardHeight: colorBoardHeight })))));
    }
